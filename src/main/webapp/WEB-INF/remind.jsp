                    ...
                    <div id="notification" class="row" style="padding: 5px;background-color: white;">
                        ...
                        <div style="margin-top: 5px;">
                            <div class="col-sm-2" style="padding-top: 20px;padding-left: 20px;">
                               <a href="#"><img src="images/icon.png" class="img-circle" width="50px;"></a>
                           </div>
                           <div class="col-sm-8" style="padding-top: 20px;padding-left: 0px;">
                             <h5><b>我叫任方成</b><span style="color: #999;font-size: 13;">&nbsp;赞了你的微博</span></h5>
                             <h6 style="color: #999">0分钟前 来自miniweibo.com</h6>
                         </div>
                         <div class="col-sm-10 pull-right" style="padding: 7px;background-color: #eee;">
                            <a href="#" style="color: orange;">@bale啊:</a><span>聚聚我行你也行</span>
                        </div>
                        <hr class="col-sm-12">
                        ...
                        <!--私信的通知-->
                        <div style="margin-top: 5px;">
                            <span class="pull-left" style="margin-left: 20px; font-size:15px;font-weight: bold;">私信</span>
                            <hr class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                             ...
                             <div class="col-sm-10" style="padding-top: 10px;padding-left: 0px;">
                                 <h5><b>我叫任方成</b><span class="pull-right" style="color: #999;font-size: 13;">&nbsp;6月11号</span></h5>
                                 <h6 style="color: #999">上次说的那个事怎么解决呢</h6>
                             </div>
                            </div>
                           ...
                           <div class="col-sm-12">
                             ...
                             <div class="col-sm-10" style="padding-top: 10px;padding-left: 0px;">
                                 <h5><b>我叫何张</b><span class="pull-right" style="color: #999;font-size: 13;">&nbsp;6月11号</span></h5>
                                 <h6 style="color: #999">聚聚，我行你也行</h6>
                             </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                             ...
                             <div class="col-sm-10" style="padding-top: 10px;padding-left: 0px;">
                                 <h5><b>我叫李志谦</b><span class="pull-right" style="color: #999;font-size: 13;">&nbsp;6月11号</span></h5>
                                 <h6 style="color: #999">LPL凉了</h6>
                             </div>
                            </div>
                        ...
                        <div style="margin-top: 5px;">
                           ...
                           <div class="col-sm-8" style="padding-top: 20px;padding-left: 0px;">
                             <h5><b>我叫任方成</b><span style="color: #999;font-size: 13;">&nbsp;转发了你的微博</span></h5>
                             <h6 style="color: #999">0分钟前 来自miniweibo.com</h6>
                         </div>
                         <div class="col-sm-10 pull-right" style="padding: 7px;background-color: #eee;">
                            <a href="#" style="color: orange;">@bale啊:</a><span>聚聚我行你也行</span>
