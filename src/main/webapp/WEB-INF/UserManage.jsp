                        ...
                        <div class="card-content">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <s:iterator value="UserList" var="Userinformation">
                                        <tr class="gradeU">
                                            <td>${Userinformation.getUser().getUserNikename()}</td>
                                            <td>${Userinformation.getFansnum()}</td>
                                            <td>${Userinformation.getIdolnum()}</td>
                                            <td class="center"><a href="messdetailManage?userid=${Userinformation.getUser().getUserId()}">微博详情</a> </td>
                                            <td class="center"><a href="deleteManage?userid=${Userinformation.getUser().getUserId()}">删除用户</a></td>
                                        </tr>
                                    </s:iterator>
